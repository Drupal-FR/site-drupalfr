...
cp -r ../www/sites/default/files ../www7/sites/default
...
cat ../export/drupalfr-live.sql | sed -e 's/^) ENGINE=InnoDB/) ENGINE=MyISAM/' | drush sqlc
...
drush sqlq "UPDATE bueditor_editors SET spriteon = 0"
