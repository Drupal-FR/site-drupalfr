...
UPDATE field_data_field_mail SET field_mail_email = CONCAT(entity_id, '@localhost');
...
UPDATE field_data_field_msn SET field_msn_email = CONCAT(entity_id, '@localhost') WHERE field_msn_email IS NOT NULL;
