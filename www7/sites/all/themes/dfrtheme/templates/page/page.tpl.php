...
<div id="page-wrapper">
  <div id="page">
    ...
    <?php if ($is_front): ?>
      ...
      <style type="text/css">
        #drupaleurope {
          background-image: url('/sites/all/themes/dfrtheme/images/drupaleurope-assets/Header_03_bg.jpg');
        ...
        #drupaleurope .darkener {
          background-image: linear-gradient(-90deg, rgba(51,168,229,.75), rgba(55,77,156,.75), rgba(171,45,146,.75));
        }
        ...
        #drupaleurope a {
          ...
          background-color: #ab2d92;
          text-decoration: none;
          margin-top: 1rem;
        }
        #drupaleurope a:focus,
        #drupaleurope a:hover {
